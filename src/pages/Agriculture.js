...
const AgriculturePage = () => {
    ...
    const countries = [
        { value: 'agriculture_rwanda', label: 'Rwanda' },
        { value: 'agriculture_nigeria', label: 'Nigeria' },
        { value: 'agriculture_kenya', label: 'Kenya' },
        { value: 'agriculture_southafrica', label: 'South Africa' },
        { value: 'agriculture_data', label: 'Africa' }
    ];
    ...
    const fetchData = async (selectedCountry) => {
        ...
        setError(null);
        try {
            const response = await axios.get(`https://ganzbe.onrender.com/agriculture/${selectedCountry}`);
            const sortedData = response.data.sort((a, b) => a.Year - b.Year);
            setAgricultureData(sortedData || []);
        } catch (error) {
    ...
    const maxValue = Math.max(...agricultureData.map(item => item["Value"]));
    ...
    const lineChartData = {
        ...
        datasets: [
            {
                label: 'Agriculture Value (Normalized)',
                        ...
                        <>
                            ...
                            <div className="flex justify-between items-center mt-8">
                                ...
                                <CSVLink
                                    ...
                                    filename={`agriculture_data_${country}.csv`}
